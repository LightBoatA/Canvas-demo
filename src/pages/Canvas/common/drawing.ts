...
const drawText = (ctx: CanvasRenderingContext2D, text: string, x: number, y: number, shapeWidth: number, fontSize: number, lineHeight: number, fontColor: string) => {
